Rays is a command line tool which makes Liferay development easier and more fun.
Inspired by Ruby on Rails.
Rays should work on any Unix-like system.

Usage: https://github.com/dmitri-carpov/rays/wiki/Usage
...
3. Install ruby 1.9.3 or higher
 $ rvm install 1.9.3

 NOTE: for XCode 4.2.x execute $ rvm install 1.9.3 --with-gcc=clang

Make version 1.9.3 default
...
5. Install rays
- Download rays gem from (https://github.com/dmitri-carpov/rays/blob/master/rays-0.1.0.gem)
- Install rays gem file
 $ gem install rays-0.1.0.gem
